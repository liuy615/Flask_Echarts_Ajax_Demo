$(function () {
	...
	echarts_r3();
	// 让ajax定时更新
	// setInterval(get_r1_data, 6000*1);
	// setInterval(echarts_l2, 6000*1);
	// setInterval(echarts_l3, 6000*1);
	// setInterval(echarts_c1, 6000*1);
	// setInterval(map, 6000*1);
	// setInterval(echarts_r1, 6000*1);
	// setInterval(echarts_r21, 6000*1);
	// setInterval(echarts_r22, 6000*1);
	// setInterval(echarts_r3, 6000*1);
	...
	function echarts_r22() {
		...
		$.ajax({
			...
			success:function (data) {
				// data=JSON.parse(data)
				var option = {
					color: ['rgb(255,235,0)', 'rgb(37,214,245)', 'rgb(255,0,255)'],
					legend: {
						y: 'top',
						top: '0%',
						data: data['type'],
